...
#include <Lab/FriendlyBacterium.hpp>
...
void FinalApplication::onRun()
{
    ...
    setStats(true);
    addGraph(s::GENERAL, { s::SIMPLE_BACTERIA, s::TWITCHING_BACTERIA, s::SWARM_BACTERIA, s::FRIENDLY_BACTERIA, s::NUTRIMENT_SOURCES,s::DISH_TEMPERATURE}, 0, 150);
    ...
    addGraph(s::LIFESPAN, {s::SIMPLE_BACTERIA, s::TWITCHING_BACTERIA, s::SWARM_BACTERIA, s::FRIENDLY_BACTERIA}, 0, 180);
    addGraph(s::HELP, {s::HELP}, 0, 50);
...
void FinalApplication::onEvent(sf::Event event, sf::RenderWindow&)
{
    if (event.type == sf::Event::KeyReleased) {
        ...
        break;
        case sf::Keyboard::F: {
            getEnv().addBacterium(new FriendlyBacterium(getCursorPositionInView()));
        }
        break;
        }
    }
