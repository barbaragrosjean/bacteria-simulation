...
void TwitchingBacterium::move(sf::Time dt)
{
    ...
    case DEPLOY:
        ...
        */
        ...
        if(getAppEnv().getNutrimentColliding(grip) != nullptr) {
            ...
            //touche la paroi -> il change de direction et retract
    ...
    case ATTRACT:
        ...
        if(getAppEnv().getNutrimentColliding(*this) != nullptr) {
            ...
            Vec2d ancienne_position(getPosition());
    ...
    case RETRACT: //tentacule se retracte
...
{
    //vecteur de deplacement genere dans une direction aleatoire
    ...
    clone->setPosition(this->getPosition()+deplacement);
    return clone;
}
